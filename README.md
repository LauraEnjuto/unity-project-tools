...
![Editor Location](images/EditorLocation.png)
...
![Crear Carpetas Proyecto](images/CrearCarpetasProyecto.png)

2. Se crearán las carpetas base automáticamente:  

![Carpetas Base](images/CarpetasBase.png)

3. Para crear la jerarquía base en la escena, ve a **Tools → Crear Hierarchy Base**.  

![Crear Hierarchy Base](images/CrearHierarchyBase.png)

4. Así es como se verá la jerarquía creada:  

![Hierarchy Base](images/HierarchyBase.png)
